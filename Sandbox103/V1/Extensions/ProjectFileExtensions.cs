...
namespace Sandbox103.V1.Extensions;

public static class ProjectFileExtensions
{
    public static IReadOnlySet<DirectProjectImport> GetImportsToRemove(this ProjectFileV1 projectFile)
    {
    ...
    public static bool RemoveImport(this ProjectFileV1 projectFile, string importedProjectName)
    {
        ArgumentNullException.ThrowIfNull(projectFile);
