...
internal static class ProgramV1
{
    static async Task MainAsync(string[] args)
    {
        ...
        IEnumerable<ProjectFileV1> all = conversion.ProjectFiles;
        IEnumerable<ProjectFileV1> rualsV1 =
        ...
        foreach (ProjectFileV1 projectFile in projectFiles)
        {
            ...
            try
            {
                ...
                XmlHelper.AddSdkElement(project, "Corext.Before", [("Condition", $"'$({ConstantsV1.EnableCorextProjectSdk})' == 'true'")]);
                XmlHelper.AddSdkElement(project, "Microsoft.NET.Sdk");
                XmlHelper.AddSdkElement(project, "Corext.After", [("Condition", $"'$({ConstantsV1.EnableCorextProjectSdk})' == 'true'")]);
        ...
        static void RemoveImportsAndAddPackageReferences(RepoConversionV1 conversion, ProjectFileV1 projectFile, XmlDocument project, XmlDocument packagesProps)
        {
