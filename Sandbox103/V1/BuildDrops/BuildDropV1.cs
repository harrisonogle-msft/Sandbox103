...
public class BuildDropV1
{
    ...
    public BuildDropV1(IOptions<SdkStyleConversionOptions> sdkStyleConversionOptions) : this(sdkStyleConversionOptions.Value.BuildDropPath)
    {
    }

    public BuildDropV1(string path)
    {
